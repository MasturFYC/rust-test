...
use crate::model::{
	Coa, LedgerBuilder, LedgerDetail, LedgerDetailBuilder, LedgerSchema,
	LedgerType,
};
...
impl LedgerDetailBuilder {
	...
	pub fn with_detail_id<T: Into<i16>>(
		mut self,
		value: T,
	) -> LedgerDetailBuilder {
	...
	pub fn with_direction<T: Into<i16>>(
		mut self,
		value: T,
	) -> LedgerDetailBuilder
// where

...
import { InlineLoading, Modal, TextInput, ComboBox } from 'carbon-components-svelte';
...
>
	<form>
		<TextInput id="gud-name" bind:value={gudang.name} labelText="Nama" placeholder="e.g. Junaedi" />
		<ComboBox
			id="gud-ware"

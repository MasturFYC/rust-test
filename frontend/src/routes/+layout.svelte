...
<Header bind:isSideNavOpen={isSideNavOpen}>
	<span slot="company"
		><img src="https://static.sapulidi.site/pixel.svg?raw=true" height="32" alt="Logo" /></span
	>
...
>
	<SideNavItems>
		...
		<Toggle labelText="Sidenav" size="sm" style="margin: 9px;" on:toggle={() => (isRail = !isRail)}>

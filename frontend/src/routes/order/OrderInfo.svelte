...
<Grid noGutter>
	<Row>
		<Column sm md noGutter>
			...
			<LabelProperty sm>
				<svelte:fragment slot="label">Tgl. penjualan</svelte:fragment>
			...
			<LabelProperty sm>
				<svelte:fragment slot="label">Pelanggan</svelte:fragment>
				<svelte:fragment slot="value">{data.customerName}</svelte:fragment>
			</LabelProperty>
			<LabelProperty sm>
				<svelte:fragment slot="label">Sales</svelte:fragment>
				<svelte:fragment slot="value">{data.salesName}</svelte:fragment>
			</LabelProperty>
		</Column>
		<Column sm md noGutter>
